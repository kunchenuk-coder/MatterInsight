    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[200] flex items-center justify-center p-6">
      <div className="bg-white p-10 rounded-[40px] w-full max-w-md shadow-2xl">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-2xl font-black">{t('recharge.title')}</h3>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          {rechargeOptions.map((opt) => (
            ...
            >
              <p className="text-xs font-black text-gray-400 uppercase mb-1">{t('recharge.get')}</p>
              <p className="text-xl font-black mb-2">{t('common.points', { count: opt.points })}</p>
        ...
        <div className="bg-gray-50 p-6 rounded-3xl flex flex-col items-center justify-center">
          <p className="text-xs font-bold text-gray-400 uppercase mb-4">{t('recharge.scanPay')}</p>
          ...
          <p className="text-[10px] text-gray-400 text-center">{t('recharge.payHint')}</p>
        </div>
      </div>
    </div>
  );
